...
// OpenRouter's API reference calls max_tokens "deprecated, use
// max_completion_tokens". The shared reasoning-details dialect defaults to the
// legacy field, so this adapter overrides it — the same override its sibling
// minimax already carried, which is how the omission here went unnoticed.
//
