...
// xAI's OpenAPI document marks max_tokens "[DEPRECATED] ... Deprecated in
// favor of max_completion_tokens". Its guide examples still pass the old field,
// which is what this adapter followed until the machine-readable spec was
// found — so the check reads the spec's answer, not the guide's.
//
